                            ...
                            <tr class="req-row hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    @if ($req->status === 'pending')
                                        <span
                                            class="px-2 py-1 text-xs font-semibold bg-gray-100 text-gray-600 rounded-full">Pending</span>
                                    @elseif($req->status === 'approved')
                                        <span
                                            class="px-2 py-1 text-xs font-semibold bg-green-100 text-green-800 rounded-full">Approved</span>
                                    @elseif($req->status === 'rejected')
                                        <span
                                            class="px-2 py-1 text-xs font-semibold bg-red-100 text-red-800 rounded-full">Rejected</span>
                                    @endif
                                </td>
