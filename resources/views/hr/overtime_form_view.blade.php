...
@section('content')
    <div class="max-w-full mx-auto space-y-8 py-8 px-4 sm:px-2 lg:px-2">

        <div class="flex justify-between">
            <h1 class="text-3xl font-bold text-blue-700 mb-3 text-center md:text-left">
            ...
            <div class="bg-white shadow border rounded-lg p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full border px-2 py-1 rounded bg-gray-50"
                    ...
                    <div class="md:col-span-2 bg-amber-50 border border-amber-300 rounded-lg px-5 py-3">
                        ...
                        <div class="grid grid-cols-3 gap-4 text-center">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-bold text-amber-800">{{ $overtime->end_time?->format('H:i') ?? '-' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <div class="inline-block bg-amber-700 text-white px-4 py-1 rounded-full font-bold text-md">
                    ...
                    <div class="md:col-span-2 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" class=" border px-2 py-1 rounded bg-gray-50"
                                value="{{ $overtime->staff->reg_no ?? '-' }}" readonly>
                        </div>

                        <!-- Type of Work – FULL WIDTH & SPACIOUS -->
                        <div class="space-y-2">
                            <label class="block font-semibold text-gray-700">Type of Work</label>
                            <textarea rows="3"
                                class="w-full border border-gray-300 p-3 rounded-lg bg-gray-50 text-sm resize-none font-medium focus:ring-2 focus:ring-blue-400"
                                readonly>
            ...
            <div class="bg-white shadow border rounded-lg p-6 space-y-6">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
                    ...
                    @if ($overtime->total_hours && $overtime->clocks->sum('total_time_taken') > 0)
                        ...
                        @endphp
                        <p class="text-md mt-2 font-medium {{ $diff > 0 ? 'text-red-600' : 'text-green-600' }}">
                            ...
                            <div class="bg-white border rounded-lg p-4 shadow-sm hover:shadow transition-shadow">
                                <div class="flex justify-between items-center">
                                    <div class="text-sm flex space-x-2">
                                        <div><span class="font-semibold">In:</span> {{ $session->clock_in->format('H:i') }}
                                        </div>
                ...
                <div>
                    ...
                    <input type="text" class="w-full border px-2 py-1 rounded bg-gray-50 text-md"
                ...
                <div>
                    ...
                    <input type="text" class="w-full border px-2 py-1 rounded bg-gray-50 text-md"
                        value="{{ $overtime->remarks }}" readonly>
                </div>
            </div>
        </div>
    </div>
