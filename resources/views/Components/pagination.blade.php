            ...
            <div class="bg-white rounded-lg shadow-md">
                <nav aria-label="Pagination" class="isolate inline-flex -space-x-px rounded-md shadow-xs">
                    ...
                    @foreach ($pages as $page)
                        @if ($page === '...')
                            <span
                                class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-700 inset-ring inset-ring-gray-300 border border-gray-200">
                                ...
                            </span>
                        @elseif ($page == $current)
                            <span aria-current="page"
                                class="relative z-10 inline-flex items-center bg-indigo-600 px-4 py-2 text-sm font-semibold text-white border border-gray-200">
                                {{ $page }}
                            </span>
                        @else
                            <a href="{{ $paginator->url($page) }}"
                                class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-900 inset-ring inset-ring-gray-300 hover:bg-gray-50 border border-gray-200">
                                {{ $page }}
                            </a>
                        @endif
                    @endforeach
